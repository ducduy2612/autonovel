...
**Sentence length uniformity**: If every sentence is the same length,
...
the same transition word, rewrite. Start with the subject. Start with
action. Start with dialogue. Start with a sense detail.
